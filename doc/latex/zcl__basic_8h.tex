...
Zig\-Bee Cluster Library; Basic Cluster (Z\-C\-L\-\_\-\-C\-L\-U\-S\-T\-E\-R\-\_\-\-B\-A\-S\-I\-C, 0x0000)  
...
Zig\-Bee Cluster Library; Basic Cluster (Z\-C\-L\-\_\-\-C\-L\-U\-S\-T\-E\-R\-\_\-\-B\-A\-S\-I\-C, 0x0000) See \hyperlink{zcl__basic__attributes_8h}{zigbee/zcl\-\_\-basic\-\_\-attributes.\-h} for an easy method to incorporate a Basic Cluster Server into an application.

\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000034}{Todo}]Explore how we would support the Device\-Enabled attribute. Does each application need to check it? Does the endpoint dispatcher need to know about it? What about clients? \end{DoxyRefDesc}
