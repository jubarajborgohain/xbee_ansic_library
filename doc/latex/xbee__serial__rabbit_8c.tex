...
Serial Interface for X\-Bee Module (Rabbit Platform) Define X\-B\-E\-E\-\_\-\-O\-N\-\_\-\-S\-E\-R\-X for every serial port that will/may have an X\-Bee, so we can compile in ser\-Xopen/ser\-Xclose functions for those ports.

\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000003}{Todo}]Need code to make sure I\-N and O\-U\-T buffers are large enough for X\-Bee. Does the out buffer need to be large enough to hold an entire frame?\end{DoxyRefDesc}
